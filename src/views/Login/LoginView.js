...
const LoginView = ({ loginUser, loginManual, loginManualMock, setMemberDetail, getMemberDetail, ...props }) => {
  ...
  return <LoginForm handleLogin={onPressLogin} handleFieldChange={handleFieldChange} loginInfo={{ email, password }} />;
};
