  ...
  execute(headers, body, isAuthen = false) {
    if (!isAuthen) {
      ...
      if (global[globalKeys.AUTH_TOKEN] !== undefined && global[globalKeys.AUTH_TOKEN] !== null) {
        console.log('============== ADD AUTH TOKEN HEADER ==============', global[globalKeys.AUTH_TOKEN]);
        this.headers.Authorization = `Bearer ${global[globalKeys.AUTH_TOKEN]}`;
      }

      if (global[globalKeys.ACCESS_TOKEN] !== undefined && global[globalKeys.ACCESS_TOKEN] !== null) {
        console.log('============== ADD ACCESS TOKEN HEADER ==============', global[globalKeys.ACCESS_TOKEN]);
